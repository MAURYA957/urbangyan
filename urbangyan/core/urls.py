...
from .views import (
    ...
    dashboard_view,
    logout,
    UserSessionListCreateAPIView,
    UserSessionDetailAPIView,
    topic_user,
    SubjectViewSet,
    UnitViewSet,
    OfferCreateAPIView,
    ...
    CartViewSet,
    OrderViewSet,
    CurrentAffairAPIView,
    current_affairs_list,
    AffairsCategoryViewSet,
    job_detail_view,
    update_user_view,
    delete_user_view,
    submit_quiz,
    upload_questions,
    upload_questions_view, set_language, create_questions_from_topic
)
...
urlpatterns = [
    ...
    path(
        "api/sessions/",
        UserSessionListCreateAPIView.as_view(),
        name="session-list-create",
    ),
    path(
        "api/sessions/<int:pk>/",
        UserSessionDetailAPIView.as_view(),
        name="session-detail",
    ),
    ...
    path(
        "blogs/<int:blog_id>/like/", views.like_blog, name="like-blog"
    ),  # Add this URL for liking a blog
    path(
        "blogs/<int:blog_id>/comment/", views.comment_blog, name="comment-blog"
    ),  # Add this URL for commenting on a blog
    ...
    path(
        "questions/create/", views.create_question_view, name="question-create-template"
    ),
    path(
        "questions/<int:pk>/update/",
        views.update_question_view,
        name="question-update-template",
    ),
    path(
        "questions/<int:pk>/delete/",
        views.delete_question_view,
        name="question-delete-template",
    ),
    ...
    path(
        "course_user/<int:course_id>/", topic_user, name="topic-user-template"
    ),  # Make sure to use course_id,
    ...
    path(
        "topics/<int:pk>/update/", views.update_topic_view, name="topic-update-template"
    ),
    path(
        "topics/<int:pk>/delete/", views.delete_topic_view, name="topic-delete-template"
    ),
    ...
    path(
        ...
        views.update_subject_view,
        name="subject-update-template",
    ),
    path(
        "subjects/<int:pk>/delete/",
        views.delete_subject_view,
        name="subject-delete-template",
    ),
    ...
    # API Views
    path(
        "offer-management/", views.OfferManagement, name="offer-management"
    ),  # Use as_view() here
    # API Views
    path("api/offers/create/", OfferCreateAPIView.as_view(), name="offer-create-api"),
    path(
        "api/offers/<int:pk>/update/",
        OfferUpdateAPIView.as_view(),
        name="offer-update-api",
    ),
    path(
        "api/offers/<int:pk>/delete/",
        OfferDeleteAPIView.as_view(),
        name="offer-delete-api",
    ),
    # MockTest views
    ...
    path(
        "mocktest/<int:pk>/update/",
        MockTestUpdateView.as_view(),
        name="mocktest-update",
    ),
    path(
        "mocktest/<int:pk>/delete/",
        MockTestDeleteView.as_view(),
        name="mocktest-delete",
    ),
    # User-specific MockTest views
    path("mocktest_user/", MockTest_user, name="mocktest-user"),
    path(
        "mocktest/<int:mocktest_id>/instructions/",
        views.instructions_view,
        name="mocktest_instructions",
    ),
    path(
        "mock-test/<int:mocktest_id>/questions/",
        mocktest_detailview,
        name="mocktest_question_detail",
    ),
    # Submission and results
    path("mock-test/<int:mocktest_id>/submit/", test_submit, name="mocktest_submit"),
    path(
        "mock-test/<int:mocktest_id>/result/<uuid:submission_uuid>/",
        views.test_result,
        name="mocktest_result",
    ),
    # News
    ...
    path(
        "current-affairs/",
        CurrentAffairAPIView.as_view(),
        name="current_affairs_list_create",
    ),
    path(
        "current-affairs/<int:pk>/",
        CurrentAffairAPIView.as_view(),
        name="current_affairs_detail",
    ),
    ...
    path(
        "upload_questions_template/",
        upload_questions_view,
        name="upload_questions_template",
    ),
    path('fetch-current-affairs/', views.fetch_current_affairs, name='fetch_current_affairs'),
    path('create-questions/', create_questions_from_topic, name='create_questions_from_topic'),
]
